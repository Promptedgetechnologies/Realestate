...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="relative -mt-12 sm:-mt-16 lg:-mt-20 z-10 px-4">
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl p-5 sm:p-6 md:p-8">
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <div className="flex-1 flex items-center space-x-3 bg-gray-50 rounded-xl p-3 sm:p-4">
                ...
                <Link
                  ...
                  className="bg-primary-600 text-white px-8 py-3 sm:py-4 rounded-xl hover:bg-primary-700 transition-all font-semibold text-center transform hover:scale-105 shadow-lg hover:shadow-xl w-full sm:w-auto"
                >
                  Search
                </Link>
              </div>
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-5 sm:p-6 rounded-2xl shadow-lg text-center hover:shadow-xl transition-all"
                >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden text-center mb-6">
            <Link
              href="/properties"
              className="text-primary-600 font-semibold inline-flex items-center justify-center gap-2"
            >
              View All →
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              >
                <FiTrendingUp className="h-7 w-7 sm:h-8 sm:w-8 text-primary-600" />
              </motion.div>
              <div>
                <h2 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent">
                  Trending Locations
                </h2>
                <p className="text-gray-600 mt-1 text-sm sm:text-base">
                  Hotspots with exceptional growth potential
                </p>
              </div>
            </div>
            <p className="text-sm text-gray-500 sm:text-base">
              Updated weekly based on user interest and price movement
            </p>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <section className="relative py-20 bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white overflow-hidden px-4">
        ...
        <div className="relative max-w-7xl mx-auto px-0 sm:px-6 lg:px-8 text-center">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-10 text-primary-100 max-w-2xl mx-auto">
            ...
            >
              <Link
                href="/properties"
                className="bg-white text-primary-600 px-8 sm:px-10 py-4 rounded-xl hover:bg-gray-100 transition-all font-bold text-lg inline-flex items-center justify-center shadow-2xl hover:shadow-3xl transform w-full sm:w-auto"
              >
                Explore Properties
              </Link>
            </motion.div>
